...
filenames_csv
k.createSurvey(filenames_csv[0],ftype='Syscal')
...
# -----------------------------------------------------------------------------
pozzi_coords = pd.read_csv('../suppInfosurvey/coordinatepozzilaghetti.txt', header='infer')
...
elecs_df.to_csv('./elecs120data_Laghetti.csv', index=False)
elecs_df.head()
...
k.saveProject('Laghetti_TL_June' + 'regMode' + str(regMode) + 'rec' + str(per_rec))
...
pl.view_xy()
pl.show(screenshot='diff_June_T1.png')
...
pl.view_xy()
pl.show(screenshot='diff_June_T2.png')
...
pl.view_xy()
pl.show(screenshot='diff_June_T3.png')
# In[ ]:
