...
for i, fcsv in enumerate(filenames_csv):
    ...
    dir_simu = '../INV/' + 'regMode' + str(regMode) + 'step' + str(i+2)
    ...
    # create survey
    # -----------------------------------------------------------------------------
    k.createSurvey('../rawData/' + fcsv, ftype='Syscal') # read the survey file
    ...
    # save project
    # -----------------------------------------------------------------------------
    k.saveProject('Salorno_2_cl5_step_rec10' + str(i+2))
