...
k.setTitle('Salorno_site2 TL12'+ 'regMode' + str(regMode))
...
# save project
# -----------------------------------------------------------------------------
#k.saveProject('Salorno_TL12' + 'regMode' + str(regMode))
#k.saveProject('Salorno_TL12' + 'regMode' + str(regMode) + 'rec10' + 'finemesh' + 'parallelF')
k.saveProject('Salorno_TL12_' + 'trimRec' + 'err10')
